...
client.on('ready', () => {
  ...
  client.guilds.forEach(function (value, key) {
    con.query(`IF NOT EXISTS (SELECT * FROM Servers WHERE guildID = ${key}) BEGIN INSERT INTO Servers (guildName, guildID) VALUES (\'${value.toString()}\', ${key.valueOf()}) END;`), (err, res) => {
      console.log(res); 
      console.log(err);
    }
  });
